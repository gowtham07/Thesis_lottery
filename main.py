...
if __name__ == '__main__':
    ...
    training_args.add_argument('--model', type=str, default='conv', choices=['fc','conv',
    ...
    training_args.add_argument('--test-batch-size', type=int, default=64,
                        help='input batch size for testing (default: 256)')
    training_args.add_argument('--pre-epochs', type=int, default=15,
                        help='number of epochs to train before pruning (default: 0)')
    training_args.add_argument('--post-epochs', type=int, default=15,
    ...
    training_args.add_argument('--weight-decay', type=float, default=0.2,
    ...
    pruning_args.add_argument('--compression-schedule', type=str, default='linear', choices=['linear','exponential'],
    ...
    pruning_args.add_argument('--compression-list', type=float, nargs='*', default=[0.5],
                        help='list of compression ratio exponents for singleshot/multishot (default: [])')
    pruning_args.add_argument('--level-list', type=int, nargs='*', default=[2],
                        help='list of number of prune-train cycles (levels) for multishot (default: [])')
    ## Experiment Hyperparameters ##
    parser.add_argument('--experiment', type=str, default='multishot', 
    ...
    parser.add_argument('--expid', type=str, default='trial_run',
